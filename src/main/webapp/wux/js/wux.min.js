...
var WUX
!function(t){function e(t,e,i,n){_showMessage(t,e,i,n)}function i(t,e,i,n){_showInfo(t,e,i,n)}function n(t,e,i){_showSuccess(t,e,i)}function o(t,e,i){_showWarning(t,e,i)}function r(t,e,i){_showError(t,e,i)}function s(t,e){_confirm(t,e)}function a(t,e,i){_getInput(t,e,i)}function l(){return $("#ptitle")}function h(){return $("#pbreadcrumb")}function u(){return $("#header")}function d(){return $("#footer")}function p(){return $("#main-menu")}function c(){return $("#view-root")}function f(t){}function g(){}function y(e,i,n){if(void 0===i&&(i=!1),void 0===n&&(n=!1),!e)return""
...
t.ATT=U
var F=function(){function t(){}return t.NORMAL={bg:"#ffffff"},t.ERROR={bg:"#fce6e8"},t.WARNING={bg:"#fef3e6"},t.SUCCESS={bg:"#d1f0ea"},t.INFO={bg:"#ddedf6"},t.COMPLETED={bg:"#eeeeee"},t.MARKED={bg:"#fff0be"},t.BTN_MED={w:110,f:12,a:"left"},t.BTN_SMALL={w:90,f:12,a:"left"},t.STACK_BTNS={pt:2,pb:2,a:"center"},t.LINE_BTNS={pl:2,pr:2,a:"center"},t.FORM_CTRL="form-control",t.FORM_CTRL_SM="form-control input-sm",t.FIELD_REQUIRED={c:"#0066cc"},t.FIELD_CRITICAL={c:"#b9233a"},t.FIELD_INTERNAL={c:"#b9233a"},t.LABEL_NOTICE={c:"#b9233a",fw:"bold"},t.LABEL_INFO={c:"#0066cc",fw:"bold"},t}()
t.CSS=F
...
e==this.state?t+='<li><a data-toggle="tab" class="active" href="#'+this.id+"-"+e+'"> '+i.name+"</a></li>":t+='<li><a data-toggle="tab" href="#'+this.id+"-"+e+'"> '+i.name+"</a></li>"}t+="</ul>",t+='<div class="tab-content">'
