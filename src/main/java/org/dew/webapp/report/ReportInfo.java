...
class ReportInfo implements Serializable 
{
   ...
   * @param sTitle String
   */
  public ReportInfo(String sTitle) {
    this.sTitle = sTitle;
  }
   ...
   */
  public ReportInfo(String sTitle, String sTemplate) {
    this.sTitle = sTitle;
   ...
   */
  public void setMarginHorizontal(double dMarginHorizontal) {
   ...
   */
  public void setMarginVertical(double dMarginVertical) {
   ...
   */
  public void setPrintDialog(boolean boPrintDialog) {
   ...
   */
  public void setPageDialog(boolean boPageDialog) {
    this.oPageDialog = Boolean.valueOf(boPageDialog);
  }

  /**
   * Restituisce il flag per la visualizzazione del dialogo di impostazione
   * pagina.
   *
   * @return Boolean
   */
  public Boolean getPageDialog() {
    return oPageDialog;
  }
   ...
   */
  public void setBackgroundText(String sBackgroundText) {
   ...
   */
  public void setReportHeader(Map<String, Object> mapValues) {
   ...
   * @param mapValues Valori
   */
  public void setPageHeader(Map<String, Object> mapValues) {
   ...
   * @return Map Valori
   */
  public Map<String, Object> getPageHeader() {
   ...
   * @param mapValues Valori
   */
  public void setReportFooter(Map<String, Object> mapValues) {
   ...
   * @return Map
   */
  public Map<String, Object> getReportFooter() {
   ...
   * @param mapValues Valori
   */
  public void setPageFooter(Map<String, Object> mapValues) {
   ...
   * @return Map
   */
  public Map<String, Object> getPageFooter() {
   ...
   */
  public void setParameters(Map<String, Object> mapParameters) {
   ...
   */
  public void addArea(String areaName, Object oValues) {
  ...
  /**
   * Aggiunge un'area dati specificando l'area a cui � legata. Nei report
   * Master-Detail � importante specificare le relazioni.
   *
   * @param areaName   String
   * @param oValues     Object
   * @param sLinkedArea Nome dell'area collegata
   */
  public void addArea(String areaName, Object oValues, String sLinkedArea) {
    listAree.add(areaName);
   ...
   * @return String
   */
  public String getAreaName(int iIndex) {
    if (listAree.size() <= iIndex)
      return null;
   ...
   */
  public Object getAreaValues(int iIndex) {
    if (listAree.size() <= iIndex)
      return null;
   ...
   * @return Object values
   */
  public Object getAreaValues(String areaName) {
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
    if (mapInfo == null)
      return null;
    return mapInfo.get(sAREA_VALUES);
   ...
   * @return String
   */
  public String getLinkedArea(int iIndex) {
    if (listAree.size() <= iIndex)
      return null;
    String areaName = (String) listAree.get(iIndex);
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
   ...
   * @return String
   */
  public String getLinkedArea(String areaName) {
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
    if (mapInfo == null)
      return null;
    return (String) mapInfo.get(sAREA_LINKEDTO);
   ...
   * @return boolean
   */
  public boolean isLinked(int iIndex) {
    if (listAree.size() <= iIndex)
      return false;
    String areaName = (String) listAree.get(iIndex);
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
   ...
   * @return boolean
   */
  public boolean isLinked(String areaName) {
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
    if (mapInfo == null)
      return false;
    String sLinkedArea = (String) mapInfo.get(sAREA_LINKEDTO);
   ...
   * @param subreport Riferimento al sottoreport
   */
  public void addSubreport(String areaName, String subreport) {
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
    if (mapInfo != null)
      mapInfo.put(sAREA_SUBREPORT, subreport);
  }
   ...
   */
  public String getAreaSubreport(int iIndex) {
    if (listAree.size() <= iIndex)
      return null;
    String areaName = (String) listAree.get(iIndex);
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
   ...
   * @return Riferimento al sottoreport
   */
  public String getAreaSubreport(String areaName) {
    Map<String, Object> mapInfo = mapAreaInfo.get(areaName);
    if (mapInfo == null)
      return null;
    return (String) mapInfo.get(sAREA_SUBREPORT);
