...
for(var p=[],h=[],c=0,u=o;c<u.length;c++){var d=u[c]
if(!l){var f=d[n]
...
var t={dataSource:this.source,commonSeriesSettings:{argumentField:"a",type:this.props,label:{visible:this.labels},point:{symbol:this.pSymbol,size:this.pSize,visible:this.pVisible}},series:this.series,title:this.title,legend:{verticalAlignment:"bottom",horizontalAlignment:"center"},export:{enabled:!0},tooltip:{enabled:!0,location:"edge",customizeTooltip:function(t){return{text:"".concat(t.seriesName,": ").concat(t.valueText)}}}}
...
if(r||this.state.series,r){for(var a=[],s={},l=0,p=0,h=o;p<h.length;p++){var c=h[p],u=e.getNumber(c,n)
l+=u
var d=e.getString(c,r)
if(d){a.indexOf(d)<0&&a.push(d)
var f=e.getNumber(s,d)
s[d]=f+u}}for(var g=0,m=a;g<m.length;g++){var d=m[g],u=e.getNumber(s,d),v=l?100*u/l:0
...
var t={dataSource:this.source,series:this.series,title:this.title,legend:{verticalAlignment:"bottom",horizontalAlignment:"center"},export:{enabled:!0},tooltip:{enabled:!0,customizeTooltip:function(t){return{text:"".concat(t.argumentText,": ").concat(t.valueText)}}}}
...
h[0]=i[0],h[1]=i[1]}else if(4==e)for(var c=0,u=t;c<u.length;c++)for(var r=u[c],d=0,f=r;d<f.length;d++)for(var h=f[d],g=0,m=h;g<m.length;g++){var v=m[g],i=ol.proj.fromLonLat(v)
