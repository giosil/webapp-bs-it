namespace WUX {
	...
	export let global: WGlobal = {
		...
		section: { b: '#e7eaec', m: '2px 0px 4px 0px', p: '4px 16px 16px 16px', bg: '#fafafa' },
		section_title: { b: 'none', f: 16, fw: '600', w: 'unset', mb: 0, tt: 'uppercase' },
	...
	export class CSS {
		...
		static readonly FIELD_REQUIRED: WStyle = { c: '#0066cc' };
		static readonly FIELD_CRITICAL: WStyle = { c: '#b9233a' };
		static readonly FIELD_INTERNAL: WStyle = { c: '#b9233a' };

		static readonly LABEL_NOTICE: WStyle = { c: '#b9233a', fw: 'bold' };
		static readonly LABEL_INFO: WStyle = { c: '#0066cc', fw: 'bold' };
	}
